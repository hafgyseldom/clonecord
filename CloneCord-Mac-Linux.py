...
# CloneCord Bot V6 BETA by !.₭₳☈.! with help from Tasky Lizard & Razorback! GClone made by Donwa on GitHub. Original Discord "GClone-Bot" by KushTheApplusser!
...
async def help(ctx, command: Optional[str]):
    ...
    helpEmbed.set_footer(
        text="Bot originally created by Kush The A++er#2976. Revamped version by !.₭₳☈.!#9600. Thanks to Pratyush.#6969 and Razorback#4637 for the help!",
